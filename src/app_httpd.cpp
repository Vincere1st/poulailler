...
#include "web/index_ov2640.h"
#include "web/index.h"
#include "web/css.h"
#include "utils/favicons.h"
...
extern void door(int val);
// extern void sunset(char *value);
// extern void sunrise(char *value);
...
static esp_err_t sun_handler(httpd_req_t *req)
{
    char *buf;
    size_t buf_len;
    char variable[32] = {
    ...
    int res = 0;
    if (!strcmp(variable, "sunset"))
    {
        Serial.println(value);
    }
    else if (!strcmp(variable, "sunrise"))
    {
        Serial.println(value);
        // sunrise(value);
    }
...
void startCameraServer(int hPort, int sPort)
{
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK)
    {
        ...
        else
        {
            ...
            httpd_register_uri_handler(camera_httpd, &sun_uri);
        }
