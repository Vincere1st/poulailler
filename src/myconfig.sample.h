 ...
 *  Timezone to get the real time zone in accordance to daylight saving, to know values see: https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv
 */
//#define NTPSERVER "<EDIT THIS>.pool.ntp.org"
//#define NTP_GMT_OFFSET 3600
//#define NTP_DST_OFFSET 3600
//#define TIME_ZONE "CET-1CEST,M3.5.0,M10.5.0/3" // Here Europe/Paris


/* 
*
* For calculate the sunset
*
*/
//#define LATITUDE
//#define LONGITUDE 
